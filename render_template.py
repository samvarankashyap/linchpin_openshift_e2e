...
result = render('/linchpin_openshift_e2e/linchpin_templates/example-topology.yml.j2',context)
write_to_file(result, '/linchpin_openshift_e2e/linchpin_workspace/topologies/example-topology.yml')
